  ...
  if (loading) {
    return (
      <div className="space-y-6">
        <h1 className="text-2xl font-bold text-slate-900">Bazaar Events</h1>
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-slate-900">Bazaar Events</h1>
          <p className="text-slate-500 text-sm mt-1">Manage pop-up sales events and inventory allocation</p>
        </div>
      ...
      {events.length === 0 ? (
        <div className="text-center py-16">
          ...
          <p className="text-slate-400 text-sm mt-1 mb-4">Create your first bazaar event to track POS sales separately</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {events.map(event => (
            <div
              ...
              className={cn(
                'bg-white rounded-xl p-5 border-2 cursor-pointer transition-all duration-200 hover:shadow-lg hover:-translate-y-0.5',
                event.status === 'active' ? 'border-green-300' : 'border-slate-200'
              )}
            >
              ...
              <div className="pt-3 border-t border-slate-100 grid grid-cols-2 gap-3">
                ...
                <div>
                  ...
                  <p className="font-bold font-mono text-slate-900">{event.orderCount}</p>
                </div>
              </div>
            </div>
          ))}
